...
class GreedyDivMax(GreedyBase, RuleSampler):
    ...
    def fit_1st_round(self, X: sp.csr_matrix, Y: sp.csr_matrix):
        ...
        while True:
            ...
            # dany 保存最佳候選規則
            # best_candidate, best_candidate_rules = self.select_best_candidate(candidate_rules)
            # self.candidate_rules |= set(best_candidate_rules)
    ...
    def fit_2nd_round(self):
        ...
        for i in range(budget):
            ...
            best_candidate = self.select_best_candidate_2(self.candidate_rules)
            logger.debug(
